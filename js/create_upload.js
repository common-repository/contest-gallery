...
// KOMMENTARFELD
  ...
  $("#cg_create_upload_add_field").click(function(){
	...
	else{$("#ausgabe1").append("<div id='"+ seCount +"' class='formField' style='width:718px;margin-bottom:20px;border: 1px solid #DFDFDF;padding-top:7px;padding-bottom:10px;display:table;padding:10px;width:856px;'><br/><input type='hidden' name='upload[]' value='se'>"+
	"<input type='hidden' value='"+ countChildren +"' name='addField[]' class='fieldValue'>"+ // Nummer des neuen Feldes wird extra versendet
 ...
 // E-Mail
   ...
   $("#cg_create_upload_add_field").click(function(){
	...
	else{$("#ausgabe1").append("<div id='"+ efCount +"' class='formField' style='width:840px;margin-bottom:20px;border: 1px solid #DFDFDF;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><input type='hidden' name='upload[]' value='ef'>"+
