...
echo "<form name='defineUpload' id='defineUpload' enctype='multipart/form-data' action='?page=contest-gallery/index.php&option_id=$GalleryID&define_output=true' method='post'>";
