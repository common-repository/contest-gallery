...
if((strpos(floatval($p_cgal1ery_reg_code)/44,".") == false
   ...
   // echo "<h4 style='margin-left:345px;'>Like this plugin? <a href='https://wordpress.org/support/plugin/contest-gallery/reviews/' target='_blank'>Rate it if you enjoy it...</a></h4>";
}
