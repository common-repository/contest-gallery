...
//update_option("p_cgal1ery_reg_code",1);
//update_option("p_c1_k_g_r_9",1);
...
else if(get_option("p_cgal1ery_count_uploads")>=1 && get_option("p_cgal1ery_count_uploads")<=50){
...
echo '<div style="display:inline;float:left;width:250px;padding-top:5px;padding-left:20px;"  id="cg_uploading_count"><b>Light version:</b> '.get_option("p_cgal1ery_count_uploads").' Uploads left <br>
<a href="https://www.contest-gallery.com/pro-version/" title="Get PRO version for unlimited uploads" target="_blank" style="font-size: 16px;">GET PRO VERSION HERE ...</a><br><br>
</div>';
...
&nbsp;&nbsp;(adding images please wait)</div>";	
    ...
    echo "<u><a href='https://www.contest-gallery.com/pro-version/' title='Get PRO version for unlimited uploads and registrations' target='_blank'>Get PRO version to upload unlimited amount of images</a></u>";
}
else{
...
if(@$_POST['contest_gal1ery_post_create_data_csv']  or (@$_POST['chooseAction1'] == 4 and (@$_POST['informId']==true or @$_POST['resetInformId']==true))){
    ...
    die('please contact support@contest-gallery.com if you see this, code 273');
...
/*
	...
	echo "<form method='POST' action='?page=contest-gallery/index.php&option_id=$GalleryID&step=$step&start=$start&edit_gallery=true'><input type='hidden' name='contest_gal1ery_create_zip' value='true' /><input type='submit' value='Zip all pictures' style='text-align:center;width:180px;' /></form></a>";
	echo "<br/>";
	echo "<form method='POST' action='?page=contest-gallery/index.php&option_id=$GalleryID&step=$step&start=$start&edit_gallery=true'><input type='hidden' name='contest_gal1ery_post_create_data_csv' value='true' /><input type='submit' value='Create data CSV' style='text-align:center;width:180px;' /></form></a>";
	}
	echo "</div></td>";
