...
$styleCenterImage = '';
	...
	$arrowPngRight = plugins_url( 'css/arrow_right.png', __FILE__ );
		...
		//$selected_look_thumb = content_url().'/plugins/contest-gallery/css/thumb-cg-view-off.png';
		$selected_look_thumb = plugins_url( '/../css/thumb-cg-view-off.png', __FILE__ );
		//$selected_look_height = content_url().'/plugins/contest-gallery/css/height-cg-view-off.png';
		$selected_look_height = plugins_url( '/../css/height-cg-view-off.png', __FILE__ );
		//$selected_look_row = content_url().'/plugins/contest-gallery/css/row-cg-view-off.png';
		$selected_look_row = plugins_url( '/../css/row-cg-view-off.png', __FILE__ );
	
		foreach($orderGalleries as $key => $value){
		
			//if($value=='ThumbLookOrder' AND $ThumbLook==1){$configuredLook = 'thumb'; $getLook = 1; $selected_look_thumb = content_url().'/plugins/contest-gallery/css/thumb-cg-view-on.png'; break;}
			if($value=='ThumbLookOrder' AND $ThumbLook==1){$configuredLook = 'thumb'; $getLook = 1; $selected_look_thumb = plugins_url( '/../css/thumb-cg-view-on.png', __FILE__ ); break;}
			//if($value=='HeightLookOrder' AND $HeightLook==1){$configuredLook = 'height'; $getLook = 2; $selected_look_height = content_url().'/plugins/contest-gallery/css/height-cg-view-on.png'; break;}
			if($value=='HeightLookOrder' AND $HeightLook==1){$configuredLook = 'height'; $getLook = 2; $selected_look_height = plugins_url( '/../css/height-cg-view-on.png', __FILE__ ); break;}
			//if($value=='RowLookOrder'  AND $RowLook==1){$configuredLook = 'row'; $getLook = 3; $selected_look_row = content_url().'/plugins/contest-gallery/css/row-cg-view-on.png'; break;}
			if($value=='RowLookOrder'  AND $RowLook==1){$configuredLook = 'row'; $getLook = 3; $selected_look_row = plugins_url( '/../css/row-cg-view-on.png', __FILE__ ); break;}
        ...
        if(!empty($_GET['1'])){
            if((@$_GET['1']==1 AND $ThumbLook==1) or (@$_GET['1']==2  AND $HeightLook==1) or (@$_GET['1']==3  AND $RowLook==1)){
                if(@$_GET['1']==1){$look = 'thumb'; $getLook = 1;
                    // 	$selected_look_thumb = content_url().'/plugins/contest-gallery/css/thumb-cg-view-on.png';
                    $selected_look_thumb = plugins_url( '/../css/thumb-cg-view-on.png', __FILE__ );
                    // 	$selected_look_height = content_url().'/plugins/contest-gallery/css/height-cg-view-off.png';
                    $selected_look_height = plugins_url( '/../css/height-cg-view-off.png', __FILE__ );
                    // 	$selected_look_row = content_url().'/plugins/contest-gallery/css/row-cg-view-off.png';
                    $selected_look_row = plugins_url( '/../css/row-cg-view-off.png', __FILE__ );
                ...
                if(@$_GET['1']==2){$look = 'height'; $getLook = 2;
                    // 	$selected_look_thumb = content_url().'/plugins/contest-gallery/css/thumb-cg-view-off.png';
                    $selected_look_thumb = plugins_url( '/../css/thumb-cg-view-off.png', __FILE__ );
                    // 	$selected_look_height = content_url().'/plugins/contest-gallery/css/height-cg-view-on.png';
                    $selected_look_height = plugins_url( '/../css/height-cg-view-on.png', __FILE__ );
                    // 	$selected_look_row = content_url().'/plugins/contest-gallery/css/row-cg-view-off.png';
                    $selected_look_row = plugins_url( '/../css/row-cg-view-off.png', __FILE__ );
                }
                if(@$_GET['1']==3){$look = 'row'; $getLook = 3;
                    ...
                    // 	$selected_look_height = content_url().'/plugins/contest-gallery/css/height-cg-view-off.png';
                    $selected_look_height = plugins_url( '/../css/height-cg-view-off.png', __FILE__ );
                    // 	$selected_look_row = content_url().'/plugins/contest-gallery/css/row-cg-view-on.png';
                    $selected_look_row = plugins_url( '/../css/row-cg-view-on.png', __FILE__ );
                }
            }
        }
...
// generate SiteURL --- ENDE
    ...
    $cg_slider_arrow_left_next_page = plugins_url( '/../css/next_page_arrows_left.png', __FILE__ );
	$cg_slider_arrow_right_next_page = plugins_url( '/../css/next_page_arrows_right.png', __FILE__ );
    ...
    $cg_slider_full_screen_icon = plugins_url( '/../css/cg_slider_full_screen_icon.png', __FILE__ );
    $cg_slider_exit_full_screen_icon = plugins_url( '/../css/cg_slider_exit_full_screen_icon.png', __FILE__ );
			...
			if($RandomSort == 1 && $sendOrder =='random-sort'){
                ...
                include(plugin_dir_path(__FILE__)."data/pics-select-then.php");
					...
					if($AllowRating==1){
                        ...
                        $picsSQL = $wpdb->get_results( "SELECT * FROM $tablename WHERE GalleryID='$galeryID' AND Active='1' ORDER BY (CountR+addCountR1+addCountR2+addCountR3+addCountR4+addCountR5) $order, rowid $order LIMIT $start, $step ");
                        include(plugin_dir_path(__FILE__)."data/pics-select-then.php");
