...
//echo "<br>getLook: $getLook<br>";
        echo "<a id='cg-begin' class='cg_gallery_begin'></a>";
...
// cg_hide Klasse ist die Div Box zum Hovern
        echo <<<HEREDOC
            <div class='cg_image$r cg-carrousel-img' data-cg_image_id="$id" id="cg-carrousel-container-id-$id">
...
echo '<div id="cg_slider_arrow_left" class="cg_slider_arrow_left_old_version"><img id="cg_slider_arrow_left_img" src="'.$cg_slider_arrow_left.'" ></div>';
echo '<div id="cg_slider_arrow_right" class="cg_slider_arrow_right_old_version"><img id="cg_slider_arrow_right_img" src="'.$cg_slider_arrow_right.'" ></div>';
...
echo '<div id="cg_slider_full_size_view_icon_div"><img id="cg_slider_full_size_view_icon_img" src="'.$cg_slider_full_size_view_icon.'" style="width:100% ;height:100% ;"></div>';
...
echo '<div id="cg_slider_download_full_size_icon_div"><a href="" target="_blank" ><img id="cg_slider_download_full_size_icon_img" src="'.$cg_slider_download_full_size_icon.'"  style="width:100% ;height:100% ;"></a></div>';
echo '<div id="cg_slider_full_screen_icon_div"><img class="cg_slider_enter_full_screen"  id="cg_slider_full_screen_icon_img" src="'.$cg_slider_full_screen_icon.'"  style="width:100% ;height:100% ;"></div>';
echo '<div id="cg_slider_exit_full_screen_icon_div"><img id="cg_slider_exit_full_screen_icon_img"  src="'.$cg_slider_exit_full_screen_icon.'"  style="width:100% ;height:100% ;"></div>';
...
if($count_pics>$PicsPerSite){
    ...
    echo "<div id='cg_further_images_container' >";
