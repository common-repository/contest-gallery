...
$language_OnlyRegisteredUsersCanVote = __("Only registered users are allowed to vote","contest-gallery");
...
$language_ConfirmationWentWrong = __("Your email could not be confirmed.","contest-gallery");

$language_URLnotValid = __("Please enter a valid URL","contest-gallery");

$language_Other = __("Other","contest-gallery");
