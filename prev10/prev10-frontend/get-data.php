...
$startOld = 0;
$countRhideUntilVote = 0;
$configuredLook = 'height';
$cg_check = '';
$widthScaledGalery = '';
$styleCenterImage = '';
        ...
        if(empty($optionsSQL)){
            ...
            echo "<p>Contest Gallery: Please check your gallery shortcode. The id does not exists.</p>";
           ...
           ?>
            ...
            $proOptions = $wpdb->get_row( "SELECT ShowOther, Manipulate, CatWidget FROM $tablename_pro_options WHERE GalleryID = '$galeryID'" );
            $Manipulate = $proOptions->Manipulate;
            $ShowOther = $proOptions->ShowOther;
            $CatWidget = $proOptions->CatWidget;
            ...
            $iconsURL = plugins_url().'/contest-gallery/prev10/prev10-css';
            ...
            if (empty($_GET['picture_id'])  OR $AllowGalleryScript == 1) {


                $categories = $wpdb->get_results( "SELECT * FROM $tablename_categories WHERE GalleryID = '$galeryID' ORDER BY Field_Order" );
                ...
                //$arrowPngRight = content_url().'/plugins/contest-gallery/prev10-css/arrow_right.png';
                $arrowPngRight = plugins_url( '/../prev10-css/arrow_right.png', __FILE__ );

                $cssFolderUrl = plugins_url( '/../prev10-css/', __FILE__ );

                //echo $cssFolderUrl;

                //$selected_look_thumb = content_url().'/plugins/contest-gallery/prev10-css/thumb-cg-view-off.png';
                $selected_look_thumb = plugins_url( '/../prev10-css/thumb-cg-view-off.png', __FILE__ );
                //$selected_look_height = content_url().'/plugins/contest-gallery/prev10-css/height-cg-view-off.png';
                $selected_look_height = plugins_url( '/../prev10-css/height-cg-view-off.png', __FILE__ );
                //$selected_look_row = content_url().'/plugins/contest-gallery/prev10-css/row-cg-view-off.png';
                $selected_look_row = plugins_url( '/../prev10-css/row-cg-view-off.png', __FILE__ );

                foreach($orderGalleries as $key => $value){

                    //if($value=='ThumbLookOrder' AND $ThumbLook==1){$configuredLook = 'thumb'; $getLook = 1; $selected_look_thumb = content_url().'/plugins/contest-gallery/prev10-css/thumb-cg-view-on.png'; break;}
                    if($value=='ThumbLookOrder' AND $ThumbLook==1){$configuredLook = 'thumb'; $getLook = 1; $selected_look_thumb = plugins_url( '/../prev10-css/thumb-cg-view-on.png', __FILE__ ); break;}
                    //if($value=='HeightLookOrder' AND $HeightLook==1){$configuredLook = 'height'; $getLook = 2; $selected_look_height = content_url().'/plugins/contest-gallery/prev10-css/height-cg-view-on.png'; break;}
                    if($value=='HeightLookOrder' AND $HeightLook==1){$configuredLook = 'height'; $getLook = 2; $selected_look_height = plugins_url( '/../prev10-css/height-cg-view-on.png', __FILE__ ); break;}
                    //if($value=='RowLookOrder'  AND $RowLook==1){$configuredLook = 'row'; $getLook = 3; $selected_look_row = content_url().'/plugins/contest-gallery/prev10-css/row-cg-view-on.png'; break;}
                    if($value=='RowLookOrder'  AND $RowLook==1){$configuredLook = 'row'; $getLook = 3; $selected_look_row = plugins_url( '/../prev10-css/row-cg-view-on.png', __FILE__ ); break;}
                ...
                if(!empty($_GET['1'])){
                    if((@$_GET['1']==1 AND $ThumbLook==1) or (@$_GET['1']==2  AND $HeightLook==1) or (@$_GET['1']==3  AND $RowLook==1)){
                        if(@$_GET['1']==1){$look = 'thumb'; $getLook = 1;
                            // 	$selected_look_thumb = content_url().'/plugins/contest-gallery/prev10-css/thumb-cg-view-on.png';
                            $selected_look_thumb = plugins_url( '/../prev10-css/thumb-cg-view-on.png', __FILE__ );
                            // 	$selected_look_height = content_url().'/plugins/contest-gallery/prev10-css/height-cg-view-off.png';
                            $selected_look_height = plugins_url( '/../prev10-css/height-cg-view-off.png', __FILE__ );
                            // 	$selected_look_row = content_url().'/plugins/contest-gallery/prev10-css/row-cg-view-off.png';
                            $selected_look_row = plugins_url( '/../prev10-css/row-cg-view-off.png', __FILE__ );
                        ...
                        if(@$_GET['1']==2){$look = 'height'; $getLook = 2;
                            // 	$selected_look_thumb = content_url().'/plugins/contest-gallery/prev10-css/thumb-cg-view-off.png';
                            $selected_look_thumb = plugins_url( '/../prev10-css/thumb-cg-view-off.png', __FILE__ );
                            // 	$selected_look_height = content_url().'/plugins/contest-gallery/prev10-css/height-cg-view-on.png';
                            $selected_look_height = plugins_url( '/../prev10-css/height-cg-view-on.png', __FILE__ );
                            // 	$selected_look_row = content_url().'/plugins/contest-gallery/prev10-css/row-cg-view-off.png';
                            $selected_look_row = plugins_url( '/../prev10-css/row-cg-view-off.png', __FILE__ );
                        }
                        if(@$_GET['1']==3){$look = 'row'; $getLook = 3;
                            ...
                            // 	$selected_look_height = content_url().'/plugins/contest-gallery/prev10-css/height-cg-view-off.png';
                            $selected_look_height = plugins_url( '/../prev10-css/height-cg-view-off.png', __FILE__ );
                            // 	$selected_look_row = content_url().'/plugins/contest-gallery/prev10-css/row-cg-view-on.png';
                            $selected_look_row = plugins_url( '/../prev10-css/row-cg-view-on.png', __FILE__ );
                        }
                    }
                }
...
// generate SiteURL --- ENDE
                ...
                if($AllowGalleryScript==1){
                    ...
                    if(!empty($selectFormInput)){
                        ...
                        $selectFormInput = $wpdb->get_results( "SELECT id, Field_Type, Field_Order, Field_Content FROM $tablename_f_input WHERE GalleryID = '$galeryID' AND ($f_input_id_collection) AND (Field_Type = 'text-f' OR Field_Type = 'comment-f' OR Field_Type ='email-f' OR Field_Type ='select-f' OR Field_Type ='selectc-f' OR Field_Type ='url-f') ORDER BY Field_Order ASC" );
                ...
                $cg_slider_button = plugins_url( '/../prev10-css/close_button.png', __FILE__ );


                //Pfeile f�r Slider URLs

                $cg_slider_arrow_left = plugins_url( '/../prev10-css/cg_slider_arrow_left_mobile.png', __FILE__ );
                $cg_slider_arrow_right = plugins_url( '/../prev10-css/cg_slider_arrow_right_mobile.png', __FILE__ );
                $cg_slider_arrow_left_next_page = plugins_url( '/../prev10-css/next_page_arrows_left.png', __FILE__ );
                $cg_slider_arrow_right_next_page = plugins_url( '/../prev10-css/next_page_arrows_right.png', __FILE__ );
                $cg_slider_arrow_fade_in_user_input = plugins_url( '/../prev10-css/arrow_fade_in_user_input.png', __FILE__ );
                $cg_slider_arrow_fade_out_user_input = plugins_url( '/../prev10-css/arrow_fade_out_user_input.png', __FILE__ );
                $cg_slider_arrow_fade_out_user_input = plugins_url( '/../prev10-css/arrow_fade_out_user_input.png', __FILE__ );
                $cg_slider_full_size_view_icon = plugins_url( '/../prev10-css/slider_full_size_view_icon.png', __FILE__ );
                $cg_slider_exit_full_size_view_icon = plugins_url( '/../prev10-css/slider_exit_full_size_view_icon.png', __FILE__ );
                $cg_slider_download_full_size_icon = plugins_url( '/../prev10-css/slider_download_full_size_icon.png', __FILE__ );
                $cg_slider_full_screen_icon = plugins_url( '/../prev10-css/cg_slider_full_screen_icon.png', __FILE__ );
                $cg_slider_exit_full_screen_icon = plugins_url( '/../prev10-css/cg_slider_exit_full_screen_icon.png', __FILE__ );

                //Star on star off f�r Slider

                $cg_star_on_slider = plugins_url( '/../prev10-css/star_48.png', __FILE__ );
                $cg_star_off_slider = plugins_url( '/../prev10-css/star_off_48.png', __FILE__ );

                $cg_star_on_gallery = plugins_url( '/../prev10-css/star_48_reduced.png', __FILE__ );
                $cg_star_off_gallery = plugins_url( '/../prev10-css/star_off_48_reduced.png', __FILE__ );


                // Auswahl aller aktviierten IDs

                $pics_sql_select_all_acitvated_ids = $wpdb->get_results( "SELECT id, Category FROM $tablename WHERE GalleryID='$galeryID' AND Active='1' ORDER BY rowid DESC");
            ...
            // 5. Count (Reihenfolge des Bildes in der Anordnung)
                ...
                foreach($categories as $category){
                    if($category->Active==1 && $CatWidget==1){
                        $categoriesCheck = 1;
                    }
                }

                //  var_dump($categoriesCheck);die;
...
// Wenn Form Output definiert ist, dann wird die Reihenfolge der Text-Bild-Anordnung ermittelt
                ...
                $selectFormOutput = $wpdb->get_results( "SELECT * FROM $tablename_f_output WHERE GalleryID='$galeryID' ORDER BY Field_Order ASC");
...
// Reihenfolge der Gallerien wird ermittelt --- ENDE
            ...
            if (empty($_GET['picture_id']) OR  $AllowGalleryScript == 1) {
                ...
                if($RandomSort == 1 && $sendOrder =='random-sort'){
                    ...
                    include(plugin_dir_path(__FILE__)."data/pics-select-prev.php");
                    ...
                    include(plugin_dir_path(__FILE__)."data/pics-select-then.php");
                    ...
                    if($AllowRating==2){
                        ...
                        $picsSQL = $wpdb->get_results( "SELECT * FROM $tablename WHERE GalleryID='$galeryID' AND Active='1' ORDER BY (CountS+addCountS) $order, rowid $order LIMIT $start, $step ");
                        include(plugin_dir_path(__FILE__)."data/pics-select-then.php");
            ...
            if(!empty($_GET['picture_id'])  AND $AllowGalleryScript != 1){
                ...
                if(!empty($picSQL)){
                    ...
                    foreach($picSQL as $value){
                        ...
                        $cgSingleImageThumbRotation = "cg".$rThumb."degree";
            ...
            */
            ...
            //$urlTransparentPic = content_url().'/plugins/contest-gallery/prev10-css/transparent.png';
            ...
            // $arrowPngLeft = content_url().'/plugins/contest-gallery/prev10-css/arrow_left.png';
            $arrowPngLeft = plugins_url( '/../prev10-css/arrow_left.png', __FILE__ );
            // $arrowPngRight = content_url().'/plugins/contest-gallery/prev10-css/arrow_right.png';
            $arrowPngRight = plugins_url( '/../prev10-css/arrow_right.png', __FILE__ );
