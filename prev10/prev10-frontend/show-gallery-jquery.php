...
if($ActivateGalleryBackgroundColor==1){
	...
	echo "<div id='mainCGdiv' style='position:relative;padding:0px !important;$GalleryBackgroundColorStyle'>";

echo "<a id='cg-begin'></a>";
...
?>
<script>
cg_check_all_acitvated_images_start_obj = {};
cg_check_all_acitvated_images_cats_start_obj = {};
<?php
    ...
    ?>
        ...
        var property = <?php echo json_encode($id);?>;
        var cat = <?php echo json_encode($catId);?>;
        cg_check_all_acitvated_images_start_obj[property] = true;
        cg_check_all_acitvated_images_cats_start_obj[property] = cat;
...
$loadingGifSource = plugins_url().'/contest-gallery/prev10/prev10-css/loading.gif';
$pngCommentsIcon = plugins_url().'/contest-gallery/prev10/prev10-css/comments_icon.png';
$pngUrlIconImg = plugins_url().'/contest-gallery/prev10/prev10-css/url_icon.png';
$cg_hide_info_png = plugins_url().'/contest-gallery/prev10/prev10-css/hide_info.png';
$cg_show_info_png = plugins_url().'/contest-gallery/prev10/prev10-css/show_info.png';
...
echo "<input type='hidden' id='cg_RandomSort_variable' value='$RandomSort' >";
...
if($cgVersion>=7){
    include("gallery/show-gallery-new.php");
}
else{
