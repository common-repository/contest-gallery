...
$starON = plugins_url( '/../prev10-css/star_48.png', __FILE__ );
$starOFF = plugins_url( '/../prev10-css/star_off_48.png', __FILE__ );
...
HEREDOC; */
		...
		if($RandomSort==1){
			$arrowPngRight = plugins_url( '/../prev10-css/arrow_random.png', __FILE__ );
		}
...
$loadingGifSource = content_url().'/plugins/contest-gallery/prev10/prev10-css/loading.gif';
//echo "$AllowComments";
