...
if($AllowSort == 1 OR $LooksCount>1 or !empty($categories)){
    ...
    if(!empty($categories)){
        ...
        foreach($categories as $category){
            ...
            echo "<label class='cg_cat_checkbox_checked' style='$visibility'>
            <input type='checkbox' class='cg_select_cat' data-cat='cg_cat_$catNameClass'  name='Category[]' $checked value='".$category->id."' style='visibility:hidden;'/>
            <span>$catName</span></label>";
            ...
            if($count==$countCategories){
                ...
                echo "<label class='cg_cat_checkbox_checked' style='$visibility'> 
                <input type='checkbox' class='cg_select_cat' name='Category[ShowOther]' data-cat='cg_cat_other_cg_gal' value='0' $checked style='visibility:hidden;'/>
                <span>$language_Other</span></label> ";
            }
...
// cg_hide Klasse ist die Div Box zum Hovern
        echo <<<HEREDOC
            <div class='cg_image$r cg-carrousel-img cg_visible $categoryClass' data-cg_image_id="$id" id="cg-carrousel-container-id-$id">
                ...
                <img src="$imgSrc" class="cg_image$r $cgImageThumbRotation" data-cg_image_id="$id" id="cg-carrousel-image-$id" style="display:none;">
            </div>
HEREDOC;
