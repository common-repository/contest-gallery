...
/*    $cg_check_1600_width = "$cg_upload_dir/$Timestamp$NamePic-1600width.$ImgType";
    ...
    echo <<<HEREDOC
    <div style='float:left;display:none;' data-cat='$categoryClass' data-cg-id='$realId' data-cat-id='$imageCategory' class='cg_show $categoryClass $cg_hide $cg_visible $cg_hide_load' id='cg_show$realId'>
...
HEREDOC;
            */
            ...
            //		$hregCGimage = 	"<a href='".$uploads."/".$Timestamp.$NamePic.".".$ImgType."' >";
                $hregCGimageValue = $imgSrcOriginal;
