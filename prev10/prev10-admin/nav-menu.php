...
//	}
	...
	echo "<td align='center'><div style='width:180px;' ><br/><strong>Upload form shortcode:</strong><br/>[cg_users_upload id=\"$GalleryID\"]<br/><br/></div></td>";
		...
		echo "<strong>Users registration/login form:</strong><br/>[cg_users_reg id=\"$GalleryID\"]<br/>[cg_users_login id=\"$GalleryID\"]<br/><br/></div></td>";
...
HEREDOC;*/
	...
	echo "<table style='border: thin solid black;background-color:#ffffff;' width='937px;'>";
	echo "<tr>";
	echo "<td align='center'><br/><div><form method='POST' action='?page=contest-gallery/index.php&option_id=$GalleryID&edit_gallery=true' ><input type='submit' value='&nbsp;<<< &nbsp;&nbsp;Back to gallery' style='text-align:left;width:180px;background:linear-gradient(0deg, #fef050 50%, #fef050 50%);' /></form><br/></div></td>";
	echo "<td align='center'><br/><div><form method='POST' action='?page=contest-gallery/index.php&edit_options=true&option_id=$GalleryID' ><input type='submit' value='Edit options' style='text-align:center;width:180px;background:linear-gradient(0deg, #bbe0ef 50%, #bbe0ef 50%);' /></form><br/></div></td>";
	echo "<td align='center'><br/><div><form method='POST' action='?page=contest-gallery/index.php&option_id=$GalleryID&define_upload=true'><input type='submit' value='Edit upload form' style='text-align:center;width:180px;background:linear-gradient(0deg, #bbe0ef 50%, #bbe0ef 50%);' /></form><br/></div></td>";
	echo "<td align='center'><br/><div>";
		...
		echo "<form method='POST' action='?page=contest-gallery/index.php&create_user_form=true&option_id=$GalleryID'><input type='hidden' name='option_id' value='$GalleryID'><input type='submit' value='Edit registration form' style='text-align:center;width:180px;background:linear-gradient(0deg, #bbe0ef 50%, #bbe0ef 50%);' /></form><br/>";
	...
	echo "<br/>";
		...
		echo "<form method='POST' action='?page=contest-gallery/index.php&users_management=true&option_id=$GalleryID'><input type='hidden' name='option_id' value='$GalleryID'><input type='submit' value='Users management' style='text-align:center;width:180px;background:linear-gradient(0deg, #ffbe4e 50%, #ffbe4e 50%);' /></form><br/>";
		echo "</div></div>";		
