...
//$GalleryID = @$_GET['option_id'];
	...
	echo "<table style='border: thin solid black;background-color:#ffffff;margin-bottom:12px;' width='937px;'>";
	echo "<tr>";
...
echo "<div style='margin-top: 7px; height:35px;'>";
		...
		<div style="display:inline;float:left;width:100px;"><button class="cg_upload_wp_images_button button">Add Images</button><br/><br/></div>
		
		<?php
		
		$plugins_url = plugins_url();
		echo "&nbsp;&nbsp;&nbsp;&nbsp;<img src='".$plugins_url."/contest-gallery/prev10/prev10-css/loading.gif' width='25px' style='display:none;' id='cg_uploading_gif'/>
