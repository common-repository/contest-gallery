...
$selectSQL3 = $wpdb->get_results( "SELECT * FROM $tablename_options_visual WHERE GalleryID = '$galeryNR'" );
    ...
    foreach($selectSQL4 as $value4){
        ...
        $ForwardAfterLoginUrlStyle = ($value4->ForwardAfterLoginUrlCheck==1) ? 'style="width:510px;"' : 'disabled style="background-color:#e0e0e0;width:510px;"';
...
echo <<<HEREDOC
        ...
        <div class="tabcontents" $styleTabContents>
            <div id="view1" class="cgMultiplePicsOptions">
HEREDOC;
...
echo "<table style='background-color:white;text-align:left;' width='545px;'>";
...
echo <<<HEREDOC
            ...
            <div id="view2" class="cgSinglePicOptions">
HEREDOC;

echo "<table style='background-color:white;' width='545px;'>";
...
echo <<<HEREDOC
            ...
            <div id="view3" class="cgGalleryOptions">
HEREDOC;
...
echo <<<HEREDOC
			   ...
			   <div id="view4" class="cgUploadOptions">
HEREDOC;
echo "<table style='background-color:white;' width='700px;'>";
echo "<tr><td style='padding-left:20px;width:300px;'>";
//echo '<input type="text" hidden name="id" value="' . $id . '" method="post" >';
...
echo "<td style='padding-left:20px;width:300px;'>";
echo '<p>Confirmation Text after Upload:<br/>(HTML tags can be inserted)</p>';
echo "</td>";
echo "<td style='padding-left:20px;570px;'>";
...
echo "<br/>";
echo 'Addressor:<br/>';
echo '<input type="text" name="from" style="width:650px;" value="'.$selectSQLemailAdmin->Admin.'" size="100" maxlength="110" ><br/>';
echo "</div>";
...
echo "<br/>";
echo 'Admin mail:<br/>';
echo '<input type="text" name="AdminMail" style="width:650px;" value="'.$selectSQLemailAdmin->AdminMail.'" size="100" maxlength="110"><br/>';
echo "</div>";
...
echo "<br/>";
echo 'Reply mail:<br/>';
echo '<input type="text" name="reply" style="width:650px;" value="'.$selectSQLemailAdmin->Reply.'" size="100" maxlength="110"><br/>';
echo "</div>";
...
echo '<input type="text" name="cc" style="width:650px;" value="'.$selectSQLemailAdmin->CC.'" size="100" maxlength="110"><br/>';
echo "</div>";
...
echo 'Bcc mail:<br/>';
echo '<small>Sending to multiple recipients example (mail1@example.com; mail2@example.com; mail3@example.com)</small><br>';
echo '<input type="text" name="bcc" style="width:650px;" value="'.$selectSQLemailAdmin->BCC.'" size="100" maxlength="110"><br/>';
echo "</div>";
...
echo 'Subject:<br/>';
echo '<input type="text" name="header" style="width:650px;" value="'.$selectSQLemailAdmin->Header.'" size="100" maxlength="110"><br/>';
echo "</div>";
...
echo <<<HEREDOC
	<div id="view5" class="cgRegistrationOptions">
HEREDOC;
...
echo "<br/>";
echo 'Addressor:<br/>';
echo '<input type="text" name="RegMailAddressor" style="width:650px;" value="'.$RegMailAddressor.'" size="120" maxlength="110" ><br/>';
echo "</div>";
...
echo "<br/>";
echo 'Reply mail:<br/>';
echo '<input type="text" name="RegMailReply" style="width:650px;" value="'.$RegMailReply.'" size="120" maxlength="200"><br/>';
echo "</div>";
...
echo "site where you inserted the short code of this gallery.</div>";
echo 'Subject:<br/>';
echo '<input type="text" name="RegMailSubject" style="width:650px;" value="'.$RegMailSubject.'" size="120" maxlength="200"><br/>';
echo "</div>";
...
echo "</div>";
echo <<<HEREDOC
	<div id="view6" class="cgLoginOptions">
HEREDOC;
...
echo "</td>";
echo "<td style='padding-left:20px;width:570px;'>";
echo '<input id="ForwardAfterLoginUrl" placeholder="'.get_site_url().'" type="text" name="ForwardAfterLoginUrl" maxlength="999" '.$ForwardAfterLoginUrlStyle.' value="'.$ForwardAfterLoginUrl.'"/><br/>';
echo "</td>";
echo "</tr>";
...
echo <<<HEREDOC
	<div id="view7" class='cgEmailConfirmationEmail'>
HEREDOC;
...
After an e-mail address is confirmed this e-mail will not be send anymore.<br>
       </h2>';
echo "<br/>";
...
echo "<br/>";
echo 'Addressor:<br/>';
echo '<input type="text" style="width:650px;" name="mConfirmAdmin" value="'.$selectSQLmailConfirmation->Admin.'" size="120" maxlength="200" ><br/>';
echo "</div>";
...
echo "<br/>";
echo 'Reply mail:<br/>';
echo '<input type="text" style="width:650px;" name="mConfirmReply" value="'.$selectSQLmailConfirmation->Reply.'" size="120" maxlength="200"><br/>';
echo "</div>";
...
echo 'Cc mail:<br/>';
echo '<small>Sending to multiple recipients example (mail1@example.com; mail2@example.com; mail3@example.com)</small><br>';
echo '<input type="text" style="width:650px;" name="mConfirmCC" value="'.$selectSQLmailConfirmation->CC.'" size="120" maxlength="200"><br/>';
echo "</div>";
...
echo 'Bcc mail:<br/>';
echo '<small>Sending to multiple recipients example (mail1@example.com; mail2@example.com; mail3@example.com)</small><br>';
echo '<input type="text" style="width:650px;" name="mConfirmBCC" value="'.$selectSQLmailConfirmation->BCC.'" size="120" maxlength="200"><br/>';
echo "</div>";
...
echo "site where you inserted the short code of this gallery.</div>";
echo 'Subject:<br/>';
echo '<input type="text" style="width:650px;" name="mConfirmHeader" value="'.$selectSQLmailConfirmation->Header.'" size="120" maxlength="200"><br/>';
echo "</div>";
...
echo "<br/>";
echo 'Addressor:<br/>';
echo '<input type="text" style="width:650px;" name="from_user_mail" value="'.$selectSQLemail->Admin.'" size="120" maxlength="200" ><br/>';
echo "</div>";
...
echo "<br/>";
echo 'Reply mail:<br/>';
echo '<input type="text" style="width:650px;" name="reply_user_mail" value="'.$selectSQLemail->Reply.'" size="120" maxlength="200"><br/>';
echo "</div>";
...
echo 'Cc mail:<br/>';
echo '<small>Sending to multiple recipients example (mail1@example.com; mail2@example.com; mail3@example.com)</small><br>';
echo '<input type="text" style="width:650px;" name="cc_user_mail" value="'.$selectSQLemail->CC.'" size="120" maxlength="200"><br/>';
echo "</div>";
...
echo 'Bcc mail:<br/>';
echo '<small>Sending to multiple recipients example (mail1@example.com; mail2@example.com; mail3@example.com)</small><br>';
echo '<input type="text" style="width:650px;" name="bcc_user_mail" value="'.$selectSQLemail->BCC.'" size="120" maxlength="200"><br/>';
echo "</div>";
...
echo "site where you inserted the short code of this gallery.</div>";
echo 'Subject:<br/>';
echo '<input type="text" style="width:650px;" name="header_user_mail" value="'.$selectSQLemail->Header.'" size="120" maxlength="200"><br/>';
echo "</div>";
...
echo '<input type="text" style="width:650px;" name="url_user_mail" placeholder="'.get_site_url().'" value="'.$selectSQLemail->URL.'" size="120" maxlength="200" ><br/>';
//echo $inputUrlLink;
