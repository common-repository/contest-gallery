...
//var_dump($valueCollect);
    ...
    if(!$cgVersion>=7){
        ...
        echo "<br>";
        echo "<div style='width:937px;background-color:#fff;margin-bottom:0px !important;margin-bottom:0px;padding: 0 10px; border: thin solid black;text-align:center;'>";
