...
HEREDOC;*/
	...
	echo "<table style='border: thin solid black;background-color:#ffffff;' width='937px;'>";
	echo "<tr>";
	echo "<td align='center'><br/><div><form method='POST' action='?page=contest-gallery/index.php' ><input type='submit' value='&nbsp;<<< &nbsp;&nbsp;Back to menu' style='text-align:left;width:180px;background:linear-gradient(0deg, #fef050 50%, #fef050 50%);'></form><br/></div></td>";
