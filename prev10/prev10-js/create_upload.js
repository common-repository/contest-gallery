...
// 5 = Felderfordernis
  ...
  // User Fields here  
	...
	var cbCount = 60+$('input#cb').size();
	var cbHiddenCount = 600+$('input#cb').size();
	...
	else{$("#ausgabe1").append("<div id='"+ cbCount +"' class='formField' style='width:855px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' name='upload[]' value='cb'>"+
...
// 7 = Felderfordernis
  ...
  $("#cg_create_upload_add_field").click(function(){
	...
	else{$("#ausgabe1").append("<div id='"+ nfCount +"' class='formField' style='width:840px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' name='upload[]' value='nf'>"+
	"<input type='hidden' value='"+ countChildren +"' name='addField[]' class='fieldValue'>"+ // Nummer des neuen Feldes wird extra versendet
	"<input type='hidden' value='nf' name='addField[]'>"+
	//"<input type='hidden' name='upload[]' class='fieldnumber' value='"+ countChildren +"'>"+// Feldnummer wird vergeben zur Orientierung in der Datenbank
	//"<input type='hidden' class='fieldnumber' value='"+ countChildren +"'>"+
...
// KOMMENTARFELD
  ...
  $("#cg_create_upload_add_field").click(function(){
	...
	else{$("#ausgabe1").append("<div id='"+ kfCount +"' class='formField' style='width:718px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;width:856px;'><br/><input type='hidden' name='upload[]' value='kf'>"+
	"<input type='hidden' value='"+ countChildren +"' name='addField[]' class='fieldValue'>"+ // Nummer des neuen Feldes wird extra versendet
  ...
  $("#cg_create_upload_add_field").click(function(){
	...
	var seCount = 70+$('textarea#se').size();
	var seHiddenCount = 700+$('textarea#se').size();

	if($('#dauswahl').val() == "se") {

		countChildren++;

	if($('textarea#se').size() == 10){
     alert("This field can be produced maximum 10 times.");
	}



	else{$("#ausgabe1").append("<div id='"+ seCount +"' class='formField' style='width:718px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;width:856px;'><br/><input type='hidden' name='upload[]' value='se'>"+
	"<input type='hidden' value='"+ countChildren +"' name='addField[]' class='fieldValue'>"+ // Nummer des neuen Feldes wird extra versendet
 ...
 // E-Mail
   ...
   $("#cg_create_upload_add_field").click(function(){
	...
	else{$("#ausgabe1").append("<div id='"+ efCount +"' class='formField' style='width:840px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><input type='hidden' name='upload[]' value='ef'>"+
 ...
 $("#cg_create_upload_add_field").click(function(){
	...
	var htCount = 50+$('input#ht').size();
	var htHiddenCount = 500+$('input#ht').size();
	...
	if($('.cg_ht_field').size() >= 10){
     alert("This field can be produced maximum 10 times.");
		...
		$("#ausgabe1").append("<div id='"+ htCount +"' class='formField cg_ht_field' style='width:840px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'>"+
		...
		"<textarea name='upload[]' maxlength='10000' rows='10' value='' style='width:857px;' placeholder='<p>Information here</p>' ></textarea><br/>"+
		"<br/></div>");
