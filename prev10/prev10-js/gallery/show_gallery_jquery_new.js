jQuery(document).ready(function($){
    ...
    var contest_gal1ery_upload_version = $("#contest_gal1ery_upload_version").val();
...
//return false;
    ...
    cgJsClass.slider.slide.values.mainCGalleryCount = $('.mainCGallery').length;
    var mainCGalleryCount = $('.mainCGallery').length;
	...
	$( window ).scroll(function() {
		...
		// cg_gallery_loading_gif entfernen und nichts machen falls alle bilder
/*        if($( "#cg_gallery_loading_gif" ).length >= 1 && $( ".cg_show" ).length == cgJsClass.slider.slide.objects.countAll){
...
if ( $( "#cg_gallery_loading_gif" ).length >= 1 ) {
...
$('title').after('<div id="cg_horizontalSpace"></div>'+
	...
	if(cg_FbLikeGallery==1){var cg_hide_hide_width=180; cgJsClass.gallery.vars.cgGalleryInfoWidth = 180; }
	 else{cg_hide_hide_width=130;cgJsClass.gallery.vars.cgGalleryInfoWidth = 130;}
...
/* // alert(cg_gallery_resize);
  ...
  if(cg_gallery_resize==1 && cg_InfiniteScrollGallery==1){
	 ...
	 // Resize ist zu Ende, nach dem cgHeightLogic ausgeführt wurde
...
/*	// Ermittlung der Höhe nach Skalierung. Falls unter der eingestellten Höhe, dann nächstgrößeres Bild nehmen.
  ...
  // var checkAggregateWidth = border;
   ...
   // console.log(i);
	...
	var imgSrcThumb = $(this).find('.imgSrcThumb').val();
	var imgSrcThumbWidth = $(this).find('.imgSrcThumbWidth').val();
	var imgSrcMedium = $(this).find('.imgSrcMedium').val();
	var imgSrcMediumWidth = $(this).find('.imgSrcMediumWidth').val();
	var imgSrcLarge = $(this).find('.imgSrcLarge').val();
	var imgSrcLargeWidth = $(this).find('.imgSrcLargeWidth').val();
	var imgSrcOriginal = $(this).find('.imgSrcOriginal').val();

        var cgImageThumbRotation = $(this).find('.cgImageThumbRotation').val();
     ...
     var cg_a_href_title = '';
        ...
        var paddingLeftRight = (width-widthDiv)/2;
            ...
            if(cgRotationThumbNumber=='90' || cgRotationThumbNumber=='270'){
                ...
                width = width*cgRotateRatio;
                var paddingLeftRight = (width-widthDiv*cgRotateRatio)/2;
	...
	// Verteilung Border und Margin oben und unten --- ENDE			
		...
		// Prüfung und bestimmung der URL Weiterleitung, falls aktiviert ist
			...
			// alert(cg_a_href_img);
			   ...
			   var cg_id_class_img = "data-cg_image_id='"+realId+"' id='cg_image_id"+realId+"' class='cg_image"+classCounter+" "+cgImageThumbRotation+"'";
			   var cg_href_img_blank = "";
      ...
      //  console.log(width);
			  ...
			  if(width<=150){
                 ...
                 // console.log('append150');

				  $(this).find(".cg_append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
				  "<img src='"+imgSrc+"' style='position:absolute;left: -"+paddingLeftRight+"px ;right:  -"+paddingLeftRight+"px ;"+
			 ...
			 if(last[i+1]=="on" && cg_InfiniteScrollGallery==1 && cg_gallery_resize!=1 || cg_gallery_resize==1 && i>=cg_pagination_position_count && last[i+1]=="on" && cg_InfiniteScrollGallery==1){	
				...
				if(check_cg_imgOffsetHTML > cg_InfiniteScrollGalleryHeight && cg_gallery_resize!=1 || cg_gallery_resize==1 && i>=cg_pagination_position_count && last[i+1]=="on"){
						...
						$("#cg_image_id"+realId+"").on('load', function(){
									...
									if(showAlways==1){  
									  ...
									  var cg_i_last_image_before_gif = i+1;
										...
										if(widthDiv<cg_hide_hide_width){
					...
					//alert(i);
                       ...
                       //     $(this).closest('.cg_show').removeClass('cg_hide_load').addClass('cg_blink_image_appear_gallery_load');
				...
				// Wenn alles duurchgegangen ist, dann kann man die gif entfernen
                $("#cg_gallery_loading_gif").remove();
...
//alert(DistancePicsX);
	...
	//alert(cg_img_url_entry);
	 ...
	 var cg_a_href_title = "title='Go to "+cg_img_url_entry+"'";
			...
			var cg_a_href_img = "href='"+hrefCGpic+"' class='cg_href_image'";
			var cg_id_class_img = "data-cg_image_id='"+realId+"' id='cg_image_id"+realId+"' class='cg_image"+r+" "+cgImageThumbRotation+"'";
        ...
        if(WidthThumbPic<=150){ //alert("300");
            ...
            if(imgSrcThumbWidth>=150){
			  ...
			  $(this).find(".cg_append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
			  "<img src='"+imgSrc+"' style='position:absolute;"+padding+";max-width:none !important;"+circleImagesOverflow+";' width='"+WidthThumbPic+"px' height='"+HeightThumbImageValue+"' "+cg_id_class_img+" >"+
			  "</a>");
			 // alert("WidthThumb1:" + WidthThumb);

		}

        else if(WidthThumbPic<=300){ //alert("300");
		...
		else if(WidthThumbPic<=1000){//alert("1000");
...
/*            if(cg_InfiniteScrollGallery!=1){
				if($(this).closest('.cg_show').hasClass('cg_hide_load')){
                    $(this).closest('.cg_show').removeClass('cg_hide_load').addClass('cg_blink_image_appear_gallery_load');
                }
            }*/
...
//alert(divHthumbHappend);
	...
	$(this).css('display','inline');
	  ...
	  if(newWidthImage<=150){ //alert("300");
		...
		//  "<img  class='cg_loading_gif_img' id='cg_loading_gif_img_"+realId+"'  src='"+cg_loadingGifSource+"' width='24px' height='24px' style='display:block;margin-left: auto;margin-right: auto;margin-top:50%;'>"+
		  "<img src='"+imgSrc+"' style='float:left !important;position:absolute;left: -2px ;right:  -2px ;max-width:none !important;"+circleImagesOverflow+";' width='"+newWidthImage+"' height='"+setNewHeight+"' "+cg_id_class_img+">"+
		  "</a>");

	  }
	  
	  else if(newWidthImage<=300){ //alert("624");
	...
	//  "<img  class='cg_loading_gif_img' id='cg_loading_gif_img_"+realId+"'  src='"+cg_loadingGifSource+"' width='24px' height='24px' style='display:block;margin-left: auto;margin-right: auto;margin-top:50%;'>"+
	  ...
	  else if(newWidthImage<=1000){// alert("1024");
...
//$('.cg_append').empty();
cgThumbLogic();
 if($('.cg_further_images_container').length>=1){

	 $('.cg_further_images_container').show();
...
/*			//var cg_icon_forward = $(this).attr('src');
			...
			var cg_src_thumb_icon = cg_css_folder_url+'thumb-cg-view-on.png';
...
/*			var cg_icon_forward = $(this).attr('src');
			...
			var cg_icon_forward_height = cg_css_folder_url+"height-cg-view-off.png";
			var cg_icon_forward_row = cg_css_folder_url+"row-cg-view-off.png";
...
//		 "<input type='hidden' id='cg_actual_configuration' value='height'>");
	...
	$('.cg_append').empty();
		...
		var cg_src_height_icon = cg_css_folder_url+'height-cg-view-on.png';


		$(this).attr('src',cg_src_height_icon);

		var cg_icon_forward_thumb = cg_css_folder_url+"thumb-cg-view-off.png";
		var cg_icon_forward_row = cg_css_folder_url+"row-cg-view-off.png";
	...
	$('.cg_append').empty();
		...
		var cg_css_folder_url = $('#cg_css_folder_url').val();
		var cg_src_row_icon = cg_css_folder_url+'row-cg-view-on.png';
