var contest_gal1ery_upload_version = jQuery("#contest_gal1ery_upload_version").val();
...
cgJsClass.slider.slide = {
    init: function(CGclickedClass){
     ...
     //   alert(cgJsClass.slider.slide.objects.currentNumber);
                        ...
                        if (jQuery("#cg_img_box_"+r1+"").length>0){
                            ...
                            if(widthCGimgSliderBox<=300){//alert("300");
                                jQuery("#imgContainer").prepend("<div style='width:"+widthDivBox+"px;' class='cg_img_box' id='"+cg_img_box_id+"'>"+
                                    ...
                                    ""+userInputDiv+""+
                                    "</div>"+
                                    "<img src='"+src300width+"' style='visibility:hidden;margin-left:"+marginSliderIMGleft+"px;' width='"+widthCGimgSliderBox+"px' class='cg_slider_image "+cgImageThumbRotation+"' id='cg_slider_image_"+realId+"'  />"+
                                    "</div>"+
                                    "</div>");}
                                ...
                                jQuery("#imgContainer").prepend("<div style='width:"+widthDivBox+"px;' class='cg_img_box' id='"+cg_img_box_id+"'>"+
                                    ...
                                    ""+userInputDiv+""+
                                    "</div>"+
                                    "<img src='"+src624width+"' style='visibility:hidden;margin-left:"+marginSliderIMGleft+"px;' width='"+widthCGimgSliderBox+"px' class='cg_slider_image "+cgImageThumbRotation+"' id='cg_slider_image_"+realId+"'  />"+
                                    "</div>"+
                                    "</div>");}
                                ...
                                jQuery("#imgContainer").prepend("<div style='width:"+widthDivBox+"px;' class='cg_img_box' id='"+cg_img_box_id+"'>"+
                                    ...
                                    ""+userInputDiv+""+
                                    "</div>"+
                                    "<img src='"+src1024width+"' style='visibility:hidden;margin-left:"+marginSliderIMGleft+"px;' width='"+widthCGimgSliderBox+"px' class='cg_slider_image "+cgImageThumbRotation+"' id='cg_slider_image_"+realId+"'  />"+
                                    "</div>"+
                                    "</div>");}
                                ...
                                jQuery("#imgContainer").prepend("<div style='width:"+widthDivBox+"px;' class='cg_img_box' id='"+cg_img_box_id+"'>"+
                                    ...
                                    ""+userInputDiv+""+
                                    "</div>"+
                                    "<img src='"+src1600width+"' style='visibility:hidden;margin-left:"+marginSliderIMGleft+"px;' width='"+widthCGimgSliderBox+"px' class='cg_slider_image "+cgImageThumbRotation+"' id='cg_slider_image_"+realId+"'  />"+
                                    "</div>"+
                                    "</div>");
                                ...
                                jQuery("#imgContainer").prepend("<div style='width:"+widthDivBox+"px;' class='cg_img_box' id='"+cg_img_box_id+"'>"+
                                    ...
                                    ""+userInputDiv+""+
                                    "</div>"+
                                    "<img src='"+src1920width+"' style='visibility:hidden;margin-left:"+marginSliderIMGleft+"px;' width='"+widthCGimgSliderBox+"px' class='cg_slider_image "+cgImageThumbRotation+"' id='cg_slider_image_"+realId+"'  />"+
                                    "</div>"+
                                    "</div>");
                                ...
                                jQuery("#imgContainer").prepend("<div style='width:"+widthDivBox+"px;' class='cg_img_box' id='"+cg_img_box_id+"'>"+
                                    ...
                                    ""+userInputDiv+""+
                                    "</div>"+
                                    "<img src='"+srcOriginalImg+"' style='visibility:hidden;margin-left:"+marginSliderIMGleft+"px;' width='"+widthCGimgSliderBox+"px' class='cg_slider_image "+cgImageSourceRotation+"' id='cg_slider_image_"+realId+"'  />"+
                                    "</div>"+
                                    "</div>");
