...
<div id="ausgabe1" style="display:table;width:875px;padding:20px 20px 20px 29px;background-color:#fff;">
...
if ($selectFormInput) {
	...
	foreach ($selectFormInput as $key => $value) {
		...
		echo "<input type='hidden' class='cg_actualID' name='actualID[]' value='$id' >";		
					...
					echo "<input type='text' class='Field_Name' name='Field_Name[$i]' value='$Field_Name'  size='30' maxlength='100'>$deleteField<br/>"; // Titel und Delete M�glichkeit die oben bestimmt wurde
		...
		echo "<input type='hidden' class='cg_actualID' name='actualID[]' value='$id' >";		
					...
					echo "<input type='text' class='Field_Name' name='Field_Name[$i]'  value='$Field_Name' placeholder='Title of your select box' size='30' maxlength='100'>$deleteField<br/>"; // Titel und Delete M�glichkeit die oben bestimmt wurde
        ...
        if(@$value->Field_Type == 'user-robot-field'){
            ...
            echo "<input type='checkbox' disabled>";
            echo "<input type='text' class='Field_Name' placeholder='I am not a robot' name='Field_Name[$i]' value='$Field_Name'  size='30' maxlength='100'>$deleteField<br/><br/>"; // Titel und Delete Möglichkeit die oben bestimmt wurde
        ...
        if(@$value->Field_Type == 'user-robot-recaptcha-field'){
            ...
            echo '<select id="cgReCaLang" name="ReCaLang">';
            ...
            echo "$deleteField<br/>";// Titel und Delete M�glichkeit die oben bestimmt wurde
            echo "<strong>Website Key</strong><br/>";
            echo "<input type='text' name='ReCaKey' placeholder='Example Key: 6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI' class='cg_reca_key' size='30' maxlength='1000' value='$ReCaKey'/>";// Titel und Delete M�glichkeit die oben bestimmt wurde
            echo "<img src='$cgRecaptchaIconUrl' title='Insert Google reCAPTCHA test key' alt='Insert Google reCAPTCHA test key' class='cg_recaptcha_icon' />";
...
<input id="submitForm" class="cg_backend_button_gallery_action" type="submit" name="submit" value="Save" style="text-align:center;width:180px;float:right;margin-right:10px;margin-bottom:10px;">
</div>
<br/>
