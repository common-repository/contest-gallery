<?php
require_once('get-data-create-user-registry-form.php');
...
echo '<div style="width:881px;padding-left:27px;padding-right:27px;background-color:white;border: thin solid black;padding-top:20px;padding-bottom:20px;margin-bottom:15px;">';
...
if ($selectFormInput) {
	...
	foreach ($selectFormInput as $key => $value) {
		...
		echo "<div id='$bhCount' class='formField'  style='width:855px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' name='upload[]' value='bh'>";
		...
		// Anfang des Formularteils
		echo "<div id='$cbCount'  class='formField' style='width:855px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' name='upload[]' value='cb'>";
		// Prim�re ID in der Datenbank
		//echo "<input type='hidden' name='upload[]' value='$fieldOrder' class='changeUploadFieldOrder'>";
		//SWAP Values
		//echo "<input type='hidden' name='changeFieldRow[$fieldOrder]' value='$fieldOrder' class='changeFieldOrderUsersEntries'>";
		...
		// Anfang des Formularteils
		echo "<div id='cg_main-mail'  class='formField' style='width:840px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' class='Field_Type' name='Field_Type[$i]' value='$Field_Type'>";
		...
		// Anfang des Formularteils
		echo "<div id='cg_password'  class='formField' style='width:840px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' class='Field_Type' name='Field_Type[$i]' value='$Field_Type'>";
		...
		// Anfang des Formularteils
		echo "<div id='cg_password-confirm'  class='formField' style='width:840px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' class='Field_Type' name='Field_Type[$i]' value='$Field_Type'>";
		...
		// Anfang des Formularteils
		echo "<div id='cg_main-user-name'  class='formField' style='width:840px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' class='Field_Type' name='Field_Type[$i]' value='$Field_Type'>";
		...
		// Anfang des Formularteils
		echo "<div id='$nfCount'  class='formField' style='width:840px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' class='Field_Type' name='Field_Type[$i]' value='$Field_Type'>";
		...
		// Anfang des Formularteils
		echo "<div id='$kfCount'  class='formField' style='width:840px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' class='Field_Type' name='Field_Type[$i]' value='$Field_Type'>";
		...
		// Anfang des Formularteils
		echo "<div id='$nfCount'  class='formField' style='width:840px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' name='upload[]' value='nf'>";
		// Prim�re ID in der Datenbank
		//echo "<input type='hidden' name='upload[]' value='$fieldOrder' class='changeUploadFieldOrder'>";
		//SWAP Values
		//echo "<input type='hidden' name='changeFieldRow[$fieldOrder]' value='$fieldOrder' class='changeFieldOrderUsersEntries'>";
...
/*		echo "<div style='width:210px;float:right;text-align:right;margin-right:10px;'>Use this field as images url: &nbsp;";
		...
		// Anfang des Formularteils
		echo "<div id='$efCount'  class='formField' style='width:840px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' name='upload[]' value='ef'>";
		// Prim�re ID in der Datenbank
		//echo "<input type='hidden' name='upload[]' value='$fieldOrder' class='changeUploadFieldOrder'>";
		//SWAP Values
		//echo "<input type='hidden' name='changeFieldRow[$fieldOrder]' value='$fieldOrder' class='changeFieldOrderUsersEntries'>";
		...
		// Anfang des Formularteils
		echo "<div id='$kfCount'  class='formField' style='width:718px;margin-bottom:20px;border: thin solid black;padding-top:7px;padding-bottom:10px;display:table;padding:10px;'><br/><input type='hidden' name='upload[]' value='kf'>";
		// Prim�re ID in der Datenbank
		//echo "<input type='hidden' name='upload[]' value='$fieldOrder' class='changeUploadFieldOrder'>";
		//SWAP Values
