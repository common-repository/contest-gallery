...
//echo "worked1";
		...
		$deleteCachedSiteFiles = $upload_dir['basedir'].'/'.cg_get_version().'/gallery-id-'.$optionID.'/cache/sites/*';
		...
		$deleteCachedSiteFilesFolder = $upload_dir['basedir'].'/'.cg_get_version().'/gallery-id-'.$optionID.'/cache/sites';
		rmdir($deleteCachedSiteFilesFolder);
		
		
		$deleteCachedGalleryFiles = $upload_dir['basedir'].'/'.cg_get_version().'/gallery-id-'.$optionID.'/cache/gallery/*';
		...
		$deleteCachedGalleryFilesFolder = $upload_dir['basedir'].'/'.cg_get_version().'/gallery-id-'.$optionID.'/cache/gallery';
		rmdir($deleteCachedGalleryFilesFolder);
		
		// delete cache folder
		$deleteCacheFolder = $upload_dir['basedir'].'/'.cg_get_version().'/gallery-id-'.$optionID.'/cache';
		...
		*/
		...
		$deletePictureFiles = $upload_dir['basedir'].'/'.cg_get_version().'/gallery-id-'.$optionID.'/*';
		// echo "<br>deleteCachedGalleryFiles: $deleteCachedGalleryFiles<br>";
		...
		$deletePictureFilesFolder = $upload_dir['basedir'].'/'.cg_get_version().'/gallery-id-'.$optionID.'';
		...
		$wpdb->query( $wpdb->prepare(
			...
			", 
				$optionID
		 		...
		 		$wpdb->query( $wpdb->prepare(
			"
				DELETE FROM $tablename_mail_gallery WHERE GalleryID = %d
			",
				$optionID
		 ));
			...
			",
				$optionID
		 		...
		 		$wpdb->query( $wpdb->prepare(
			"
				DELETE FROM $contest_gal1ery_create_user_entries WHERE GalleryID = %d
			",
				$optionID
		 ));
