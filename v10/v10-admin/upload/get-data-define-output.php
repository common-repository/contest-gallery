		...
		// Feldcontent
			...
			if($a==3){
				...
				"
					...
					VALUES ( %s,%d,%d,%s,%d,%s )
				",
					'',$f_input_id,$GalleryID,'url-f',$i,$value
			 ) );
				$a=0;$actualStage = ' ';
		...
		// Feldcontent
			...
			if($a==3){
				...
				"
					...
					VALUES ( %s,%d,%d,%s,%d,%s )
				",
					'',$f_input_id,$GalleryID,'select-f',$i,$value
			 ) );
				$a=0;$actualStage = ' ';
		...
		// Feldcontent
			...
			if($a==3){
				...
				"
					...
					VALUES ( %s,%d,%d,%s,%d,%s )
				",
					'',$f_input_id,$GalleryID,'selectc-f',$i,$value
			 ) );
				$a=0;$actualStage = ' ';
...
var_dump($GalleryID);
	...
	if($_POST['submit-form-output']){
        ...
        $fp = fopen($file, 'w');
        fwrite($fp, json_encode($selectFormOutput));
        fclose($fp);
...
//echo "<br>";
        ...
        $freeOutputFields = false;

/*var_dump($onlyInputIDs);
echo "<br>";
echo "<br>";
echo "<br>";
