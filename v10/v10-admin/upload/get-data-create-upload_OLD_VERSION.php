		...
		foreach($newFormFields as $key => $value){
			...
			// 5 = Felderfordernis
				...
				$nextIDgallery = $last->Auto_increment-1; // Get the new id of the gallery options which will be created
                     $setField1IdGalleryView = $nextIDgallery;
...
if(!empty($setField1IdGalleryView)){

    var_dump('write options');
    ...
    $optionsFileData['visual']['Field1IdGalleryView'] = $setField1IdGalleryView;
