...
if((strpos(floatval($p_cgal1ery_reg_code)/44,".") == false
    ...
    or in_array($p_c1_k_g_r_8, $arrayNew)
		...
		echo "<td style='padding-left:23px;overflow:hidden;'><h4 style='display:inline;'>You are using PRO version. For any issues on PRO version please contact <br/><a href='mailto:support-pro@contest-gallery.com' target='_blank'>support-pro@contest-gallery.com</a></h4></td>";
	}
	else{
...
$unix = time();
		...
		echo "<table width='635px' style='border: 1px solid #DFDFDF;background-color:#ffffff;'>";
            ...
            style="text-align:center;width:70px;background:linear-gradient(0deg, #bbe0ef 50%, #bbe0ef 50%);"></form></p></td>';
            ...
            style="text-align:center;width:70px;background:linear-gradient(0deg, #f1f1f1 50%, #f1f1f1 50%);"></form></p></td>';
            ...
            style="text-align:center;width:70px;background:linear-gradient(0deg, #fef050 50%, #fef050 50%);"></form></p></td>';
...
echo "<table style='border: 1px solid #DFDFDF;background-color:#ffffff;' width='635px'>";
    ...
    <input name="" value="New gallery" type="Submit" style="background:linear-gradient(0deg, #f1f1f1 50%, #f1f1f1 50%);"></form></p></td></tr>';
