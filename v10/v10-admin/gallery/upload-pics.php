...
$WPdestination = $uploads['basedir'].'/'.cg_get_version().'/gallery-id-'.$galeryID.'/'; // Pfad zum Bilderordner angeben
if (isset($_FILES['files']) && $_FILES['files']['size'] > 0) {
  ...
  if ($dateityp[2] == 1 || $dateityp[2] == 2 || $dateityp[2] == 3) { // GIF o. JPG?
    if ($dateigroesse <= $maxigroesse) { // Datei zu gro�?
...
//Dateigr��e: <b>$dateigroesse</b> Byte, 
