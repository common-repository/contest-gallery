cgJsClass.gallery.function.search.getFullImageDataFiltered = function(gid,ids,isFromCategoriesOrSearch){
        ...
        var filtered = true;
        cgJsClass.gallery.sorting.initSort(gid,filtered,isFromCategoriesOrSearch);
