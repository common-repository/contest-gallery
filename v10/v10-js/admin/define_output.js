...
// NORMALES FELD
	...
	if($('#cg_define_output .sec').is(':selected')) {
		...
		"<div class='formFieldInnerDiv'>"+
		"<div style='display:inline;float:left;margin-top:15px;font-size:16px;'>"+fieldtitelShow+":</div>"+
		"<input type='hidden' name='output[]' class='sec' value='sec'><input type='hidden' name='output[]' class='form_input_id' value='"+id+"'><input class='cg-delete' type='button' value='-' alt='"+fieldtype+"' titel='"+fieldtitelShow+"' style='width:20px;float:left;margin-top:10px;margin-bottom:10px;margin-left:10px;'><br/>"+
		"<input type='hidden' name='output[]' value='"+fieldtitelShow+"'><input type='text' value='' size='102' style='width:855px;' disabled style='background-color: white;'><br/><br/></div></div>");
     //   location.href = "#cg"+id+"";
        location.href = "#cg_define_output";
